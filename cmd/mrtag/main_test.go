...
func TestMain(m *testing.M) {
	...
	os.Setenv("MRTAG_MB_BASE_URL", "file:///testdata/responses/musicbrainz/ws/2")
	os.Setenv("MRTAG_MB_RATE_LIMIT", "0")
	os.Setenv("MRTAG_CAA_BASE_URL", "file:///testdata/responses/coverartarchive")
	os.Setenv("MRTAG_CAA_RATE_LIMIT", "0")

	os.Exit(testscript.RunMain(m, map[string]func() int{
		"mrtag":    func() int { main(); return 0 },
